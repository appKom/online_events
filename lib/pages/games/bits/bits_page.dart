...
const bitsPages = [
  ...
  BitsModel(header: 'Pekelek', body: 'Spiller mest Smash på A4', imageSource: 'assets/bits/bitsimage5.png'),
  BitsModel(
      header: 'Immball', body: '"Av med buksene" Ta av et valgfrittplagg', imageSource: 'assets/bits/bitsimage6.png'),
  BitsModel(header: 'Pekelek', body: 'Startet å få poeng i yngst alder', imageSource: 'assets/bits/bitsimage7.png'),
  BitsModel(
      header: 'Kontoret',
  ...
  BitsModel(
      header: 'Appslipp',
      body: 'Alle får poeng for å feire utgivelsen av Online-appen',
  ...
  BitsModel(header: 'POENG!', body: '', imageSource: 'assets/bits/bitsskaal.png'),
  ...
  BitsModel(header: 'Bedpres', body: 'Du kan gi ut fem poeng', imageSource: 'assets/bits/bitsimage17.png'),
  BitsModel(
  ...
  BitsModel(header: 'Oktoberfest', body: 'Fullfør det du har i hånden', imageSource: 'assets/bits/bitsimage23.png'),
  BitsModel(header: 'Pekelek', body: 'Tar best lambo', imageSource: 'assets/bits/bitsimage1.png'),
  BitsModel(
      header: 'OW er nede', body: 'Du får 5 poeng for å få OW opp igjen', imageSource: 'assets/bits/bitsimage25.png'),
  BitsModel(header: 'Pekelek', body: 'Havner oftest på legevakten', imageSource: 'assets/bits/bitsimage26.png'),
  BitsModel(
      header: 'Swap',
      body: 'Bytt et klesplagg med personen til venstre for deg',
      imageSource: 'assets/bits/bitsimage25.5.png'),
  BitsModel(header: 'POENG!', body: '', imageSource: 'assets/bits/bitsskaal.png'),
  BitsModel(header: 'Pekelek', body: 'Knuser flest hjerter', imageSource: 'assets/bits/bitsimage18.png'),
  BitsModel(
      header: 'Vinter OL',
  ...
  BitsModel(header: 'Kok', body: 'Du blir tatt for kok, du får 5 poeng', imageSource: 'assets/bits/bitsimage31.png'),
